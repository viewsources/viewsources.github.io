if (document.querySelector('audio') != null) {
	...
	var timeholder = document.querySelector('.episode--player_time');
	...
	function timeUpdate() {
		...
		if (music.currentTime == duration) {
			pButton.className = "";
			pButton.className = "episode--player_play episode--player_icon";
		}
	...
	function play() {
		...
		if (music.paused) {
			...
			pButton.className = "";
			pButton.className = "episode--player_pause episode--player_icon";
		} else { // pause music
			music.pause();
